function [sigma_n]=ir_GA(sigma_n,sigma_PRECISION,iter_GA)%利用高斯近似求出初始化的度分布的迭代阈值的信噪比
global IT_MAX
global pe_limit
global var_degree
global ch_degree
...
global ch_index
change_point=10;
alpha=-0.4527;beta=0.0218;gama=0.86;Phi_star=exp(alpha*change_point^gama+beta);%phi(x)在0<x<10的近似式
count=0;flag=0;
while (1)
    iter_mu0=-1; 
