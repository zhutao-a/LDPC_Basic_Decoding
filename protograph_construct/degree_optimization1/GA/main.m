...
global IT_MAX
global pe_limit
R=111/128; % rate of code
IT_MAX=8; %Number of iteration in BP decoder
pe_limit= 1e-6; % BER level of error
count=0;
[var_people]=initial(R,IT_MAX,pe_limit);

[I_NP,I_D]=size(var_people);
I_itermax = 13;iter_GA=4; % Setting for differential evolution iteration of DE
