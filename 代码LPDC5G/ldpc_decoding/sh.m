...
%block_array=zeros(1,length(dB));
    ...
    %[vHat,n1]= LayeredDecoding(rx_waveform',H, max_iter);
    %[vHat]=group(rx_waveform',H, max_iter);
    [vHat,n3]= LayeredDecoding1(rx_waveform',H, max_iter);
      %vhat = decode_OMS(rx_waveform',H, max_iter)
     %vhat = decode_MS(rx_waveform',H,max_iter)
     %  vhat = decodeLogDomainSimple1231(rx_waveform, H,max_iter)
