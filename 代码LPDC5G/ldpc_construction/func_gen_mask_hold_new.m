function  [mask, hold_idx] = func_gen_mask_hold_new(base_size)
    ...
    prob = 0; %0.56     % probability to mask another row insdie the belt
    hold_idx_diff = 0;
...
%     for j = 1:base_size(2)
	...
	% mask for the parity part of the base matrix
