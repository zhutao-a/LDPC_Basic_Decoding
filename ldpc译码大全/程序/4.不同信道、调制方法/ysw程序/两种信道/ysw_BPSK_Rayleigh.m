...
BPSK_Rayleigh_BER=BER; 
BPSK_Rayleigh_FER=FER;
save BPSK_Rayleigh_BER.mat snrs BPSK_Rayleigh_BER BPSK_Rayleigh_FER
figure(1)
plot(snrs,BPSK_Rayleigh_BER,'bo-','linewidth',2);
xlabel('SNR');ylabel('BER');
figure(2)
plot(snrs,BPSK_Rayleigh_FER,'bo-','linewidth',2)
