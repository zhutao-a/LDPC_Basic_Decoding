...
codeRate = 1/4;  % 可能的取值 1/4, 1/3, 2/5, 1/2, 3/5, 2/3, 3/4, 4/5, 5/6, 8/9, and 9/10. The block length of the code is 64800
...
BER2_1=BER; 
FER2_1=FER;
save BPSK_BER2_1.mat snrs BER2_1 FER2_1
figure(1)
plot(snrs,BER2_1,'bo-','linewidth',2);
xlabel('SNR');ylabel('BER');
figure(2)
plot(snrs,FER2_1,'bo-','linewidth',2)
