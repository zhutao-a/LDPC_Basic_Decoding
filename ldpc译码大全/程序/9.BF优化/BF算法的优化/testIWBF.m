...
biterrorsIWBF=zeros(length(iteration),length(EbN0_All));
...
figure;
semilogy(EbN0_All,berIWBF(1,:),'-o');
hold on
semilogy(EbN0_All,berIWBF(2,:),'-*');
hold on
semilogy(EbN0_All,berIWBF(3,:),'-s');
hold on
semilogy(EbN0_All,berIWBF(4,:),'-x');
hold on
semilogy(EbN0_All,berIWBF(5,:),'->');
grid on
