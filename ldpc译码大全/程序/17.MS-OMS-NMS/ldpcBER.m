...
%       ber5(i) = 0;
   ...
   for j = 1:frame
     ...
     % tx = bpskMod + sqrt(N0/2)*randn(size(bpskMod));
      ...
      vhat2 = decodeProbDomain1(tx, newH, N0);
...
%h=legend('MS基于最小和次小值间距差改进','NMS(factor=0.8)');
