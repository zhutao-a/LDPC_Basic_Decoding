...
function vHat2 = decodeProbDomain(rx, H, N0)
...
for n = 1:10
  ...
  %T = log( ((1/2)^(1/dc))/(1-(1/2)^(1/dc))  )
   if rem(H*vHat2', 2) ~= 0
       n = n+1 ;
   else
       if rem(H*vHat2', 2) == 0 & Q < 0.881373
           n=n+1;
       else if  rem(H*vHat2', 2) == 0 & Q < 0.881373
           break;
           end
       end
   end
